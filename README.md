...
The following screenshots were provided with this repository and are included here for quick reference.

- Home / Overview

   ![Home Screenshot](project%20images/1.png)

- Orders / Sales View

   ![Orders Screenshot](project%20images/2.png)

- Customer / Details View

   ![Customer Screenshot](project%20images/3.png)

- Python data preparation / report snapshot

   ![Python Snapshot](project%20images/4.png)

   ---

   Supply Chain Management Dashboard — concise overview

   Overview

   This repository contains a compact, ready-to-open dataset and documentation for a Supply Chain Management Dashboard built with Power BI. The dashboard focuses on automotive supply-chain KPIs (inventory, orders, supplier performance and sales trends) and includes example data preparation and visualization guidance.
   ...
   2. Open Power BI Desktop and load `Car_SupplyChainManagementDataSet.csv` via `Get Data` → `Text/CSV`.
   3. Use Power Query to clean data (remove unused columns, set types) and create a date table.
   4. In Model view, create relationships and add core DAX measures (e.g., `Total Sales`, `On-time %`).
   5. Build visuals across pages (Home, Orders, Sales, Customer View) and use the included screenshots as layout references.

   Files of interest

   - `Car_SupplyChainManagementDataSet.csv` — primary dataset for the dashboard
